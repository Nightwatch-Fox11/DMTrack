...
class DepthTrack(BaseVideoDataset):
    ...
    def __init__(self, root=None, dtype='rgbcolormap', split='train',
                 image_loader=jpeg4py_loader_w_failsafe):  # vid_ids=None, split=None, data_fraction=None
        """
        args:
    ...
    def _build_sequence_list(self):
        ...
        file_path = os.path.join(ltr_path, 'data_specs', 'depthtrack_train.txt')
    ...
    def _read_bb_anno(self, seq_path):
        ...
        gt = pandas.read_csv(bb_anno_file, delimiter=',', header=None, dtype=np.float32, na_filter=True,
