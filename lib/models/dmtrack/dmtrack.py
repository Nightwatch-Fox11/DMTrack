...
from lib.models.dmtrack.vit_ce_adapter import vit_base_patch16_224_ce_adapter
from lib.utils.box_ops import box_xyxy_to_cxcywh


class DMTrack(nn.Module):
    """ This is the base class for DMTrack """
...
def build_dmtrack(cfg, training=True):
    ...
    """For PEFT no need, because we have OSTrack as initialization"""
